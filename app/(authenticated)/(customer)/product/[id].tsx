    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        <View className="p-4">
          ...
          {/* Price */}
          <Text className="text-2xl font-outfit-bold text-gray-800 mb-4">
            {formatPrice(product.price)}
          </Text>

          {/* Description */}
          <Text className="font-outfit text-base leading-6 text-gray-600 mb-6">
            {product.description}
          </Text>
          ...
          <View className="mb-6">
            <View className="flex-row justify-between items-center mb-3">
              ...
              {/* Size guide link */}
              <TouchableOpacity>
                <Text className="text-sm font-outfit text-pink-500">
                  Size Guide
                </Text>
              </TouchableOpacity>
            </View>
                ...
                >
                  <Text
                    className={`font-outfit text-base ${
                      selectedSize === sizeOption.size
                        ? "text-pink-500 font-outfit-medium"
                        : "text-gray-800"
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center">
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  const sizeStock = product.stockSize.find(
                ...
                disabled={
                  !selectedSize ||
                  (product.stockSize.find((s) => s.size === selectedSize)
                    ?.quantity ?? 0) <= quantity
                }
              >
                <Text className="text-xl">+</Text>
          ...
          <View className="flex-row mb-6">
            <TouchableOpacity className="flex-1 h-12 justify-center items-center bg-gray-200 mr-2">
              <Text className="text-sm font-outfit-medium text-gray-800">
                TRY ON WITH AI
              </Text>
            </TouchableOpacity>
