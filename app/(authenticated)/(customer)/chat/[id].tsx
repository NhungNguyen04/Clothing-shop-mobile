...
export default function ChatScreen() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Get seller details
        setSellerName(conversation.seller.managerName || 'Seller');
        setSellerImage(conversation.seller.image || 'https://randomuser.me/api/portraits/thumb/women/44.jpg');
  ...
  const renderMessageItem = ({ item }: { item: Message }) => {
    ...
    const sellerNameValue = sellerName || 'Seller';
        ...
        {!isCurrentUser && (
          sellerImage ? (
            ...
            <View style={[styles.avatarImage, styles.initialsAvatar]}>
              <Text style={styles.initialsText}>{getInitials(sellerNameValue)}</Text>
            </View>
          )
        )}
              ...
              {sellerImage ? (
                ...
                <View style={[styles.headerAvatar, styles.initialsHeaderAvatar]}>
                  <Text style={styles.initialsHeaderText}>
                    {sellerName ? sellerName.substring(0, 1).toUpperCase() : 'S'}
                  </Text>
                </View>
              )}
